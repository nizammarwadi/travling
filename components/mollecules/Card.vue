        ...
        <div v-for="(item, index) in dataUser" :key="index" class="rating-user">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a @click="editDataUser(item)">Edit</a>
                    <a @click="deleteDataUser">Delete</a>
                </div>
            </div>
        </div>
    </section>
...
export default {
   ...
   methods: {
       ...
       editDataUser(item) {
        //    this.chooseRating = item.review_star
        //    axios.put('https://review-backend.herokuapp.com/api/v1/review' , dataUser)
        //    .then(res => {
        //        this.dataUser = res.data.data
        //        console.log(this.dataUser);
        //    })
